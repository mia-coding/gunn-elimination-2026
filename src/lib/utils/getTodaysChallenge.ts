const rules = {
    ...
    12: 'To eliminate others, players must be playing a song with no profanity from their phone or laptop before the elimination (THAT IS LOUD ENOUGH FOR THEIR TARGET TO HEAR)',
